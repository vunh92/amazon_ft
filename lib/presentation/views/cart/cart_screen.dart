...
import 'bloc/cart_offers_cubit2/cart_offers_cubit.dart';
import 'bloc/cart_offers_cubit3/cart_offers_cubit.dart';
import 'bloc/cart_offers_cubit_1/cart_offers_cubit.dart';
...
class CartScreen extends StatelessWidget {
  ...
  getCartOffers(context) async {
    ...
    await getIt<CartOffersCubit1>().setOfferCategories();
    getIt<CartOffersCubit1>().cartOffers1(category: categories[0]);
    getIt<CartOffersCubit2>().cartOffers2(category: categories[1]);
    getIt<CartOffersCubit3>().cartOffers3(category: categories[2]);
  }
                            ...
                            child: state.cartProducts.isEmpty
                              ...
                              children: [
                                ...
                                CustomElevatedButton(
                                  ...
                                  onPressed: () {
                                    context.pushNamed(
                                        AppRouteConstants.paymentScreenRoute.name,
                                        extra: state.total);
                                  },
                                  isRectangle: true,
                                ),
