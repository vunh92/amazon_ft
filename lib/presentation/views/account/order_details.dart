...
import 'bloc/product_rating_bloc.dart';
import 'widgets/shipment_details.dart';
import 'widgets/standard_delivery_container.dart';
  ...
  Widget build(BuildContext context) {
    return RatingBar.builder(
      ...
      onRatingUpdate: (rating) {
        BlocProvider.value(
          value: getIt<ProductRatingBloc>()..add(
