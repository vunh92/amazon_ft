...
import 'bloc/fetch_account_screen_data_cubit.dart';
import 'widgets/account_screen_app_bar.dart';
import 'widgets/name_bar.dart';
            ...
            Padding(
              ...
              child: BlocConsumer<FetchAccountScreenDataCubit,
                ...
                listener: ((context, state) {
                  if (state is FetchAccountScreenDataErrorState) {
                    showSnackBar(context, state.errorString);
                  }
                }),
                builder: (context, state) {
                  if (state is FetchAccountScreenDataLoadingState) {
                    return const Center(
                      child: CircularProgressIndicator(),
                    );
                  }
                  if (state is FetchAccountScreenDataEmptyState) {
                    return SizedBox(
                      height: 150,
                      child: Center(
                  ...
                  if (state is FetchAccountScreenDataSuccessState) {
                    return Column(
                      children: [
